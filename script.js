...
function init() {
	...
	document.querySelector("#clear_cake").addEventListener("click", clearCake);
	...
	document.querySelector("#save_button_wrapper button").addEventListener("click", () => {
		...
		if (!document.querySelector(`#container_2 [data-feature="texture1"]`).classList.contains("hide")) {
		...
		if (!document.querySelector(`#container_2 [data-feature="texture2"]`).classList.contains("hide")) {
		...
		if (!document.querySelector(`#container_2 [data-feature="texture3"]`).classList.contains("hide")) {
		...
		if (!document.querySelector(`#container_2 [data-feature="candles"]`).classList.contains("hide")) {
			localStorage.setItem("candles", "hide");
		}
		if (!document.querySelector(`#container_2 [data-feature="flowers"]`).classList.contains("hide")) {
			localStorage.setItem("flowers", "hide");
		}
		if (!document.querySelector(`#container_2 [data-feature="birthday"]`).classList.contains("hide")) {
			localStorage.setItem("birthday", "hide");
		}
		if (!document.querySelector(`#container_2 [data-feature="wedding"]`).classList.contains("hide")) {
	...
	if (localStorage.texture1 == "hide") {
		...
		document.querySelector(`#container_2 [data-feature="texture1"]`).classList.remove(localStorage.texture1);
	}
	if (localStorage.texture2 == "hide") {
		document.querySelector(`#container_2 [data-feature="texture1"]`).classList.add("hide");
		document.querySelector(`#container_2 [data-feature="texture3"]`).classList.add("hide");
		document.querySelector(`#container_2 [data-feature="texture2"]`).classList.remove(localStorage.texture2);
	}
	if (localStorage.texture3 == "hide") {
		document.querySelector(`#container_2 [data-feature="texture1"]`).classList.add("hide");
		document.querySelector(`#container_2 [data-feature="texture2"]`).classList.add("hide");
		document.querySelector(`#container_2 [data-feature="texture3"]`).classList.remove(localStorage.texture3);
	}
	if (localStorage.candles == "hide") {
		document.querySelector(`#container_2 [data-feature="candles"]`).classList.remove(localStorage.candles);
	}
	if (localStorage.flowers == "hide") {
		document.querySelector(`#container_2 [data-feature="flowers"]`).classList.remove(localStorage.flowers);
	}
	if (localStorage.birthday == "hide") {
		document.querySelector(`#container_2 [data-feature="birthday"]`).classList.remove(localStorage.birthday);
	}
	...
	ishidden.forEach((item) => {
		if (!item.classList.contains("hide")) {
			...
			const setChosen = document.querySelector(`#container_1 [data-feature=${setTrue}`);
...
function clearCake() {
	...
	document.querySelector("#bottom_layer .cls-5").style.fill = "white";
	document.querySelector("#middle_layer .cls-5").style.fill = "white";
	document.querySelector("#top_layer .cls-5").style.fill = "white";
	document.querySelector("#border").style.fill = "white";

	document.querySelector(`#container_2 [data-feature="wedding"]`).classList.add("hide");
	document.querySelector(`#container_2 [data-feature="candles"]`).classList.add("hide");
	document.querySelector(`#container_2 [data-feature="birthday"]`).classList.add("hide");
	document.querySelector(`#container_2 [data-feature="flowers"]`).classList.add("hide");

	document.querySelector(`#container_2 [data-feature="texture1"]`).classList.add("hide");
	document.querySelector(`#container_2 [data-feature="texture2"]`).classList.add("hide");
	document.querySelector(`#container_2 [data-feature="texture3"]`).classList.add("hide");

	document.querySelector("#feature_text").innerHTML = "";

	const weddingChosen = document.querySelector(`#container_1 [data-feature=wedding`);
	weddingChosen.querySelector("img").classList.remove("chosen");

	const birthdayChosen = document.querySelector(`#container_1 [data-feature=birthday`);
	birthdayChosen.querySelector("img").classList.remove("chosen");

	const flowersChosen = document.querySelector(`#container_1 [data-feature=flowers`);
	flowersChosen.querySelector("img").classList.remove("chosen");

	const candlesChosen = document.querySelector(`#container_1 [data-feature=candles`);
	candlesChosen.querySelector("img").classList.remove("chosen");

	const texture1Chosen = document.querySelector(`#container_1 [data-feature=texture1`);
	texture1Chosen.querySelector("img").classList.remove("chosen");

	const texture2Chosen = document.querySelector(`#container_1 [data-feature=texture2`);
	texture2Chosen.querySelector("img").classList.remove("chosen");

	const texture3Chosen = document.querySelector(`#container_1 [data-feature=texture3`);
	texture3Chosen.querySelector("img").classList.remove("chosen");
...
function toggleOption(event) {
	...
	if (feature === "texture1" || feature === "texture2" || feature === "texture3") {
		...
		if (feature === "texture1") {
			...
			document.querySelector(`#container_1 [data-feature="texture2"] img`).classList.remove("chosen");
			document.querySelector(`#container_1 [data-feature="texture3"] img`).classList.remove("chosen");
		} else if (feature === "texture2") {
			features["texture1"] = false;
			features["texture3"] = false;
			document.querySelector(`#container_1 [data-feature="texture1"] img`).classList.remove("chosen");
			document.querySelector(`#container_1 [data-feature="texture3"] img`).classList.remove("chosen");
	...
	if (features[feature]) {
		...
		if (feature === "candles" || feature === "flowers" || feature === "wedding" || feature === "birthday") {
			...
			const firstFrame = document
				.querySelector(`#container_1 .feature_container #item_features .item_wrapper[data-feature="${feature}"]`)
